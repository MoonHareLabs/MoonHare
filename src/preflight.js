...
export default function preflight(processor, html, includeBase = true, includeGlobal = true, includePlugins = true) {
    // Generate preflight style based on html tags.
    const globalSheet = new StyleSheet();
    const styleSheet = new StyleSheet();
    const createStyle = (selector, properties, isGlobal = false) => {
